...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return example; });\n/* harmony import */ var _singleSticker_makeMapSticker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../singleSticker/makeMapSticker */ \"./src/singleSticker/makeMapSticker.js\");\n/* harmony import */ var _singleSticker_Sticker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../singleSticker/Sticker */ \"./src/singleSticker/Sticker.js\");\n\r\n\r\n\r\nfunction example() {\r\n    const makeSticker = (title, content, type) => {\r\n        const sticker = new _singleSticker_Sticker__WEBPACK_IMPORTED_MODULE_1__[\"default\"](title, content, type);\r\n        sticker.create();\r\n        sticker.show();\r\n    }\r\n    makeSticker('Become an expert in JavaScript', 'As soon as posible', 'newSticker');\r\n    makeSticker('Learn React', 'On middle level', 'newSticker');\r\n    makeSticker('Learn Node.JS', 'And develop multi-user services', 'newSticker');\r\n    makeSticker('To find a cool job', 'With good salary', 'newSticker');\r\n    Object(_singleSticker_makeMapSticker__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('ВДНХ на карте', 'Посетить выставку промышленного оборудования (пищевая пром-ть; станки для бахил и т.п.)', 'editMapSticker', 'Пр-т Мира, 119, Москва');\r\n\r\n    const ex = document.getElementById('example');\r\n    ex.remove();\r\n}\n\n//# sourceURL=webpack:///./src/transmission/example.js?");
