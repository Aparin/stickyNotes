...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Sticker; });\n/* harmony import */ var _out__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../out */ \"./src/out.js\");\n/* harmony import */ var _singleSticker_currentId__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../singleSticker/currentId */ \"./src/singleSticker/currentId.js\");\n/* harmony import */ var _singleSticker_makeDOMElement__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../singleSticker/makeDOMElement */ \"./src/singleSticker/makeDOMElement.js\");\n/* harmony import */ var _singleSticker_addMiniSigns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../singleSticker/addMiniSigns */ \"./src/singleSticker/addMiniSigns.js\");\n/* harmony import */ var _singleSticker_editSticker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../singleSticker/editSticker */ \"./src/singleSticker/editSticker.js\");\n/* harmony import */ var _singleSticker_editMapSticker__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../singleSticker/editMapSticker */ \"./src/singleSticker/editMapSticker.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nclass Sticker {\r\n    constructor(name = '', content = '', type = 'simple', adress) {\r\n        this.type = type;\r\n        this.name = name;\r\n        this.content = content;\r\n        this.id = Object(_singleSticker_currentId__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\r\n        this.adress = adress;\r\n    }\r\n\r\n    create() {\r\n        const area = document.getElementById('stickyNotes');\r\n        const wrap = Object(_singleSticker_makeDOMElement__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('div', 'newSticker', '', this.id);\r\n        const fragment = document.createDocumentFragment();\r\n\r\n        fragment.appendChild(Object(_singleSticker_addMiniSigns__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(this.id));\r\n        fragment.appendChild(Object(_singleSticker_makeDOMElement__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('h1', '', this.name)); // adding headline\r\n        if (this.type === 'map') {\r\n            const adr = Object(_singleSticker_makeDOMElement__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('p', '', this.adress);\r\n            adr.id = `adress${this.id}`;\r\n            fragment.appendChild(adr);\r\n        }\r\n        fragment.appendChild(Object(_singleSticker_makeDOMElement__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('p', '', this.content));\r\n        wrap.appendChild(fragment);\r\n        area.appendChild(wrap);\r\n        document.getElementById(this.id).setAttribute('data-action', 'sticker');\r\n    }\r\n\r\n    hide() {\r\n        document.getElementById(this.id).style = 'display: none';\r\n    }\r\n\r\n    show() {\r\n        document.getElementById(this.id).style = 'display: display-block';\r\n    }\r\n    mini() {\r\n        //состояние стикера в свёрнутом виде\r\n    }\r\n\r\n    full() {\r\n        if (this.type === 'map') {\r\n            Object(_singleSticker_editMapSticker__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(this.id);\r\n        } else {\r\n            Object(_singleSticker_editSticker__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(this.id);\r\n        }\r\n    }\r\n\r\n    move() {\r\n        //перемещение стикера\r\n    }\r\n\r\n    setId() {\r\n        //установить id\r\n    }\r\n\r\n    addUrl() {\r\n\r\n    }\r\n}\n\n//# sourceURL=webpack:///./src/model/Sticker.js?");
