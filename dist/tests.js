...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _makeDOMElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./makeDOMElement */ \"./src/model/makeDOMElement.js\");\n/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./state */ \"./src/model/state.js\");\n/* harmony import */ var _start_testData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../start/testData */ \"./src/start/testData.js\");\n/* harmony import */ var _start_testError__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../start/testError */ \"./src/start/testError.js\");\n/* eslint-disable no-undef */\n/* eslint-disable spaced-comment */\n\n\n\n\n\n\n/****************** MODEL *****************/\n/***** makeDOMelement  *****/\nlet module = 'makeDOMelement';\ndescribe(module, () => {\n  try {\n    it('Проверка создания узла', () => {\n      assert.equal(Object(_makeDOMElement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('р', 'red', 'Hi, world').outerHTML, '<р class=\"red\">Hi, world</р>');\n      assert.equal(Object(_makeDOMElement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('div', 'red', 'Hi, world').outerHTML, '<div class=\"red\">Hi, world</div>');\n      assert.equal(Object(_makeDOMElement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('div', 'red').outerHTML, '<div class=\"red\"></div>');\n    });\n  } catch (e) {\n    Object(_start_testError__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(module, e);\n  }\n});\n\n/***** state  *****/\nmodule = 'state';\ndescribe(module, () => {\n  try {\n    it('Запись и чтение массива', () => {\n      _state__WEBPACK_IMPORTED_MODULE_1__[\"default\"].set(_start_testData__WEBPACK_IMPORTED_MODULE_2__[\"testState\"]);\n      assert.equal(_start_testData__WEBPACK_IMPORTED_MODULE_2__[\"testState\"], _state__WEBPACK_IMPORTED_MODULE_1__[\"default\"].get());\n    });\n    it('Добавление элемента в конец массива', () => {\n      _state__WEBPACK_IMPORTED_MODULE_1__[\"default\"].add(_start_testData__WEBPACK_IMPORTED_MODULE_2__[\"testObj\"]);\n      const stLng = _state__WEBPACK_IMPORTED_MODULE_1__[\"default\"].get().length;\n      assert.equal(_state__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getElement(stLng), _start_testData__WEBPACK_IMPORTED_MODULE_2__[\"testObj\"]);\n    });\n    it('Запись и чтение элемента', () => {\n      _state__WEBPACK_IMPORTED_MODULE_1__[\"default\"].setElement(_start_testData__WEBPACK_IMPORTED_MODULE_2__[\"testState\"][0]);\n      assert.equal(_state__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getElement(1), _start_testData__WEBPACK_IMPORTED_MODULE_2__[\"testState\"][0]);\n    });\n    it('Вставка элемента', () => {\n      _state__WEBPACK_IMPORTED_MODULE_1__[\"default\"].insertElement(1, _start_testData__WEBPACK_IMPORTED_MODULE_2__[\"testObj\"]);\n      assert.equal(_state__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getElement(1), _start_testData__WEBPACK_IMPORTED_MODULE_2__[\"testObj\"]);\n    });\n    it('Удаление элемента', () => {\n      _state__WEBPACK_IMPORTED_MODULE_1__[\"default\"].delElement(1);\n      assert.equal(_state__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getElement(1), _start_testData__WEBPACK_IMPORTED_MODULE_2__[\"testState\"][0]);\n    });\n  } catch (e) {\n    Object(_start_testError__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(module, e);\n  }\n});\n\n\n//# sourceURL=webpack:///./src/model/modelTests.js?");
...
/***/ "./src/start/testData.js":
/*!*******************************!*\
  !*** ./src/start/testData.js ***!
  \*******************************/
/*! exports provided: testObj, testState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"testObj\", function() { return testObj; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"testState\", function() { return testState; });\nconst testObj = { title: 'New title' };\nconst testState = (() => {\n  const ts = [];\n  for (let i = 0; i < 4; i += 2) {\n    ts[i] = {\n      title: `Title${i}`, content: `content${i}`, keyWords: `keyword${i}`, adress: '',\n    };\n    const j = i + 1;\n    ts[j] = {\n      title: `Title${j}`, content: `content${j}`, keyWords: `keyword${j}`, adress: `adress${j}`,\n    };\n  }\n  return ts;\n})();\n\n\n//# sourceURL=webpack:///./src/start/testData.js?");

/***/ }),

/***/ "./src/start/testError.js":
/*!********************************!*\
  !*** ./src/start/testError.js ***!
  \********************************/
/*! exports provided: default */
