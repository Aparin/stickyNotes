...
export default function example() {
    ...
    makeSticker('Карта: карнавал в Рио-Де-Жанейро', 'Традиционно перед началом Великого поста,)', 'фестивали, путешествия', 'Рио-Де-Жанейро');
    makeSticker('Learn Node.JS', 'And develop multi-user services', 'учёба');
    makeSticker('Карта: день королевы в Нидерландах', 'Ежегодно 30 апреля в Амстердаме празднуется День коронации правящей королевы Беатрикс', 'путешествия', 'Амстердам');
    makeSticker('To find a cool job', 'With good salary', 'деньги');
    makeSticker('Питер, Фонтанка, карта', 'Нужно съездить как-нибудь', 'путешествия', 'Питер, Фонтанка');
